              ...
              return  Column(
                children: [
                  GestureDetector(onTap: (){
                    Get.to(Description(
                      img:controller.elements[index]["urlToImage"],
...
//Image.network("https://media.istockphoto.com/id/828503954/photo/cricket-spin-bowler.jpg?s=612x612&w=0&k=20&c=gK_WotKret7BmZFkLRUyxi9udVlJgBrIyLrq8Co0vI0=",fit: BoxFit.cover,);
